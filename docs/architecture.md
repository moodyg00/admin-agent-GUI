...
## UI Layer
coss ui preferred for all screens. shadcn/ui allowed only with clear justification that it improves UX. All interfaces must feel premium and agent-native.
